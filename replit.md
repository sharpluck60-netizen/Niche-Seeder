...
- **Photo Studio**: Sidebar-accessible prompt studio with 38 photo filter types inspired by user-provided examples, searchable categories, source photo upload, optional direction notes, and copyable generated prompts
