...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    { href: "/dashboard", label: "OPSEC DASHBOARD", icon: Activity },
    ...
    <div className="min-h-screen flex flex-col md:flex-row relative">
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto py-4 px-3 space-y-1">
          ...
          <div className="mt-3 mx-3 border border-border/30 bg-secondary/10 p-2.5">
            <div className="text-[9px] text-muted-foreground/60 uppercase tracking-widest text-center font-mono">
              {navItems.length} modules loaded
            </div>
          </div>
        </nav>
