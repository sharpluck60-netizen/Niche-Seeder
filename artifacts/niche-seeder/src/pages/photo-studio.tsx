...
const studioFilters: StudioFilter[] = [
  ...
  // ── Seasonal & Nature ────────────────────────────────────────────────────
  { name: "Cherry Blossom Spring", category: "Seasonal", vitality: "Sakura petals, soft pink light, Japanese spring warmth", tone: "pink", prompt: "Cherry blossom spring portrait with soft pink bokeh petal background, warm diffused spring light, delicate sakura petal overlay, pastel skin tones, and gentle Japanese seasonal atmosphere." },
  { name: "Golden Autumn", category: "Seasonal", vitality: "Amber leaves, warm harvest light, rich depth", tone: "amber", prompt: "Golden autumn portrait with rich amber and deep orange fallen leaf bokeh, warm harvest sunlight, textured bark and leaf detail, and cinematic autumnal warmth and depth." },
  { name: "Winter Frost", category: "Seasonal", vitality: "Ice crystal detail, cool blue light, breath mist", tone: "blue", prompt: "Winter frost portrait with cool blue-white tonal palette, frosted breath mist, delicate ice crystal bokeh, crisp cold light, and sharp wintry atmosphere." },
  { name: "Tropical Summer", category: "Seasonal", vitality: "Vivid jungle green, golden sun, lush backdrop", tone: "green", prompt: "Tropical summer portrait with lush deep green foliage, golden direct sun overhead, vivid flower accents, warm humid atmosphere, and vibrant saturated skin tones." },
  { name: "Misty Forest", category: "Seasonal", vitality: "Atmospheric fog, dappled light, dark emerald depth", tone: "green", prompt: "Misty forest portrait with cool atmospheric fog between dark tree trunks, dappled green-filtered light, forest floor depth, and a serene moody woodland atmosphere." },
  { name: "Desert Dusk", category: "Seasonal", vitality: "Red sand, long shadows, deep crimson horizon", tone: "orange", prompt: "Desert dusk portrait with warm red-orange sand, long dramatic low-angle shadows, deep crimson and gold horizon sky, arid heat haze, and sweeping empty landscape depth." },

  // ── Portrait FX Filters ───────────────────────────────────────────────────
  { name: "Dramatic Chiaroscuro", category: "Portrait FX", vitality: "Deep shadow, single key light, Renaissance drama", tone: "slate", prompt: "Dramatic chiaroscuro portrait with a single directional key light against deep black shadow, rich tonal contrast, Caravaggio-style light placement, and intense emotional presence." },
  { name: "Soft Focus Dreamy", category: "Portrait FX", vitality: "Diffused glow, hazy edges, romantic softness", tone: "pink", prompt: "Soft focus dreamy portrait with classic diffusion filter glow, halation bloom on highlights, gentle haze on edges, and a timeless romantic soft-light atmosphere." },
  { name: "High Fashion Editorial", category: "Portrait FX", vitality: "Studio clean, sharp contrast, magazine finish", tone: "slate", prompt: "High fashion editorial portrait with crisp clean studio lighting, sharp shadow definition, polished skin retouching, strong contrast, and Vogue-quality magazine editorial finish." },
  { name: "Golden Skin Glow", category: "Portrait FX", vitality: "Luminous warm skin, honey light, radiant beauty", tone: "amber", prompt: "Golden skin glow portrait with warm honey-amber light on skin, luminous subsurface glow, clean beauty lighting, vibrant warm shadows, and radiant editorial skin finish." },
  { name: "Cinematic Portrait", category: "Portrait FX", vitality: "Film-grade color, shallow depth, cinematic crop", tone: "blue", prompt: "Cinematic portrait with film-grade color treatment, 2.39:1 letterbox crop, shallow depth-of-field 85mm lens simulation, anamorphic lens flare, and atmospheric cinematic haze." },
  { name: "Neon Portrait Glow", category: "Portrait FX", vitality: "Colored neon edge light, dark studio, vivid contrast", tone: "cyan", prompt: "Neon portrait style with vivid colored neon edge lighting — pink and cyan rims — against a deep dark background, strong color contrast, moody studio atmosphere, and sharp detail." },
  { name: "Black & White Film", category: "Portrait FX", vitality: "Timeless monochrome, rich tonal range, deep expression", tone: "slate", prompt: "Black and white film portrait with rich tonal range, deep expressive shadows, zone system tonal balance, fine grain texture, and timeless monochromatic elegance." },

  // ── Mood & Emotion ────────────────────────────────────────────────────────
  { name: "Melancholy Blue", category: "Mood", vitality: "Desaturated cool tones, window light, introspection", tone: "blue", prompt: "Melancholy blue mood portrait with heavily desaturated cool blue tonal palette, single window light casting long shadows, quiet introspective expression, and atmospheric emotional depth." },
  { name: "Euphoria Burst", category: "Mood", vitality: "Overexposed joy, color bloom, peak happiness energy", tone: "pink", prompt: "Euphoria mood portrait with bright overexposed joyful lighting, vibrant color bloom on highlights, radiant warm skin tones, dynamic expressive pose, and peak happiness visual energy." },
  { name: "Mysterious Shadows", category: "Mood", vitality: "Partial obscurity, intrigue, dark allure", tone: "slate", prompt: "Mysterious shadow mood portrait with partial face obscured by deep shadow, single low-angle directional light, hidden eyes or features, cool desaturated tones, and dark alluring intrigue." },
  { name: "Serene Calm", category: "Mood", vitality: "Neutral tones, soft diffused light, peaceful stillness", tone: "blue", prompt: "Serene calm mood portrait with neutral soft color grading, gently diffused natural light, relaxed neutral expression, shallow focus, and profound peaceful visual stillness." },
  { name: "Bold Confidence", category: "Mood", vitality: "Strong color, direct gaze, powerful composition", tone: "orange", prompt: "Bold confidence mood portrait with saturated strong color, direct unflinching subject gaze into camera, clean strong lighting, powerful frame composition, and undeniable confident presence." },
  { name: "Romantic Warm", category: "Mood", vitality: "Warm golden haze, soft focus, tender atmosphere", tone: "amber", prompt: "Romantic warm mood portrait with golden hour haze, soft focus on background, warm amber-rose color grading, gentle expression, and tender intimate visual atmosphere." },

  // ── Digital Art Styles ────────────────────────────────────────────────────
  { name: "Stable Diffusion XL", category: "Digital Art", vitality: "AI art aesthetic, hyper-detailed realism, crisp generation", tone: "purple", prompt: "Stable Diffusion XL style portrait with ultra-detailed hyper-realistic skin texture, sharp focus on facial features, rich color depth, and AI art generation aesthetic quality." },
  { name: "Midjourney Aesthetic", category: "Digital Art", vitality: "Painterly realism, cinematic depth, polished AI finish", tone: "blue", prompt: "Midjourney v6 aesthetic portrait with painterly photorealistic quality, beautiful cinematic depth, polished color harmony, and the signature elegant AI generation visual style." },
  { name: "Concept Art", category: "Digital Art", vitality: "Game design spec, environment mood, character focus", tone: "purple", prompt: "Video game concept art style portrait with detailed character design, atmospheric environment backdrop, strong lighting design, bold color keys, and professional game studio spec quality." },
  { name: "Anime Film Still", category: "Digital Art", vitality: "Studio Ghibli depth, lush color, hand-painted quality", tone: "green", prompt: "Anime film still style with Studio Ghibli inspired hand-painted quality, lush natural color palette, soft atmospheric depth, expressive character face, and cinematic screen capture composition." },
  { name: "Pixel Perfect", category: "Digital Art", vitality: "Isometric sprite, sharp pixel grid, game character identity", tone: "cyan", prompt: "Pixel perfect portrait style with clean isometric sprite composition, 32x32 up-scaled character detail, game-accurate color palette, sharp pixel boundary, and retro game identity character feel." },
  { name: "Cel Shaded 3D", category: "Digital Art", vitality: "Toon shader, bold ink lines, animation studio quality", tone: "orange", prompt: "Cel shaded 3D portrait style with clean toon shader rendering, bold black ink outline, flat color fills with sharp specular highlights, and animation studio quality character finish." },
];
...
const categoryNegativeExtras: Record<string, string> = {
  ...
  Seasonal: "studio lighting, indoor environment, artificial background, flat digital color, overprocessed",
  "Portrait FX": "busy background, flat lighting, snapshot quality, overexposed, casual phone photo",
  Mood: "neutral flat lighting, expressionless, overlit, stock photo bland, clinical white background",
  "Digital Art": "film grain analog, hand-drawn, organic imperfection, lo-fi texture, printed paper",
};
